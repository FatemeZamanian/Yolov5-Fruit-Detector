...
class FruitsDetection(QWidget):
    def __init__(self):
        ...
        self.ui.btn_start.clicked.connect(run(source=self.file))
...
#     parser.add_argument('--source', type=str, default=widget.file, help='file/dir/URL/glob, 0 for webcam')
